...
// 12 FIXED UNIQUE NAMED GIFT BOXES DATA
const luckyData = [
  { id: 1, name: "🍬 Cái Kẹo Ngọt", text: "Chúc bạn may mắn lần sau (hên lắm mới xu được vậy)", gifts: 0, meme: "assets/meme_sad.jpg", sticker: "😭 XU CÀ NA RỒI!" },
  { id: 2, name: "🧺 Cái Thúng Thần Kỳ", text: "Bạn được nhận 1 phần quà đến từ nhóm 4 dễ thương", gifts: 1, meme: "assets/meme_congrats.jpg", sticker: "🎁 NHÓM 4 BAN THƯỞNG!" },
  { id: 3, name: "🎋 Chiếc Nón Bí Ẩn", text: "Chúc mừng bạn! Người kế bên của bạn nhận được phần quà của bạn", gifts: 1, meme: "assets/meme_sad.jpg", sticker: "🤝 KÉ LỘC CHO BẠN BÊN CẠNH!" },
  { id: 4, name: "🥥 Quả Dừa May Mắn", text: "Chọn một người bất kỳ để tặng cho người đó", gifts: 1, meme: "assets/meme_congrats.jpg", sticker: "💘 BÙA YÊU! TẶNG BẠN BẤT KỲ" },
  { id: 5, name: "🍌 Nải Chuối Vàng", text: "Bạn là người may mắn nhất hôm nay, x3 quà nhé", gifts: 3, meme: "assets/meme_congrats.jpg", sticker: "👑 NỔ HŨ X3 QUÀ TRUYỆN THUYẾT!" },
  { id: 6, name: "🐚 Vỏ Sò Tí Hon", text: "WOA WOA giỏi vậy ta, 1 phần quà nhen", gifts: 1, meme: "assets/meme_congrats.jpg", sticker: "🔥 WOA WOA ĐỈNH CỦA CHÓP!" },
  { id: 7, name: "🪭 Cái Quạt Mát Mẻ", text: "Trai xinh gái đẹp nào trả lời đúng vậy ta, cho x2 quà nhé", gifts: 2, meme: "assets/meme_congrats.jpg", sticker: "✨ TRAI XINH GÁI ĐẸP X2 QUÀ!" },
  { id: 8, name: "🌸 Bông Hoa May Mắn", text: "Tuyệt vời rồi, 1 phần quà sẽ được trao đến bạn nho", gifts: 1, meme: "assets/meme_congrats.jpg", sticker: "👍 TUYỆT VỜI Ô MẶT TRỜI!" },
  { id: 9, name: "🥁 Cái Trống Rộn Ràng", text: "Ỏ đỉnh vậy chời, cho 1 phần quà nha", gifts: 1, meme: "assets/meme_congrats.jpg", sticker: "🥺 Ỏ ĐỈNH VẬY CHỜI!" },
  { id: 10, name: "🎁 Gói Quà Bất Ngờ", text: "Tốt, có tập trung bài thuyết trình, x2 lên cho trẫm", gifts: 2, meme: "assets/meme_congrats.jpg", sticker: "👑 TRẪM KHIẾN BAN X2 QUÀ!" },
  { id: 11, name: "🍀 Cỏ May Siêu Hên", text: "Nhóm 4 có VIP không ạ :3, trả lời đúng thì có thưởng", gifts: 1, meme: "assets/meme_congrats.jpg", sticker: "💎 NHÓM 4 VIP PRO MAX!" },
  { id: 12, name: "⭐ Ngôi Sao Hy Vọng", text: "Em đã thành công thu hút sự chú ý của tôi, thưởng", gifts: 1, meme: "assets/meme_congrats.jpg", sticker: "💘 THẢ THÍNH THÀNH CÔNG!" }
];
...
function handleQuestionTimeout() {
  ...
  document.getElementById('modalQStatus').innerHTML = '<span style="color: #9B2C2C;"><i class="fa-solid fa-clock"></i> ⏰ HẾT THỜI GIAN!</span>';
  audio.wrong();

  optionsGrid.innerHTML = `
    <div class="wrong-notice-box">
      <i class="fa-solid fa-clock" style="font-size: 1.6rem; margin-bottom: 0.3rem; display: block; color: #9B2C2C;"></i>
      "Đã hết 20 giây! Mời người chơi khác thử sức nhé."
    </div>
  `;
...
function selectAnswer(selectedIdx) {
  ...
  if (isCorrect) {
    // 1. CORRECT ANSWER LOGIC: SHOW ANSWER, EXPLANATION & RENDER "🎁 ĐẾN HỘP QUÀ" BUTTON AT BOTTOM RIGHT!
    ...
    footerActions.innerHTML = `
      ...
      <button class="btn btn-open-gift-cta" onclick="proceedToLuckyWithTransition()">
        <i class="fa-solid fa-gift"></i> 🎁 ĐẾN HỘP QUÀ
      </button>
    `;
  } else {
    ...
    optionsGrid.innerHTML = `
      <div class="wrong-notice-box">
        <i class="fa-solid fa-face-grimace" style="font-size: 1.6rem; margin-bottom: 0.3rem; display: block; color: #9B2C2C;"></i>
...
function showLuckyViewFromHeader() {
  ...
  if (answeredQ === 9) {
    document.getElementById('gameInfoBanner').innerText = '🎉 CHÚC MỪNG! BẠN ĐÃ HOÀN THÀNH 9/9 CÂU HỎI!';
    document.getElementById('luckySubtitleText').innerText = `🎉 Còn ${remainingBoxes} Hộp Quà May Mắn đang chờ bạn khám phá!`;
  } else {
    document.getElementById('gameInfoBanner').innerText = 'Chọn 1 Hộp Quà May Mắn chưa mở bên dưới để nhận phần thưởng!';
    document.getElementById('luckySubtitleText').innerText = `Hãy chọn một hộp quà chưa mở để khám phá phần thưởng bất ngờ! (Còn ${remainingBoxes} hộp)`;
  }
}
...
function showQuestionSelectionView() {
  ...
  const answeredQ = questionsState.filter(q => q.status === 'answered_correct').length;
  if (answeredQ === 9) {
    document.getElementById('gameInfoBanner').innerText = `🎉 ĐÃ HOÀN THÀNH 9/9 CÂU HỎI! Còn ${remainingBoxes} Hộp Quà May Mắn!`;
  } else {
    document.getElementById('gameInfoBanner').innerText = 'Chọn 1 câu hỏi ➜ Trả lời ĐÚNG ➜ Mở Hộp Quà May Mắn!';
  }
}
...
// PREMIUM GAME SHOW REWARD POPUP MODAL & MASCOT STAGE ANIMATIONS
function openLuckyModal(lData) {
  ...
  if (claimBtn) {
    if (unopenedCount > 0) {
      claimBtn.innerHTML = `<i class="fa-solid fa-gift"></i> 🎁 TIẾP TỤC MỞ QUÀ (${unopenedCount} HỘP CÒN LẠI)`;
    } else {
      claimBtn.innerHTML = `<i class="fa-solid fa-trophy"></i> 🎉 CHÚC MỪNG HOÀN THÀNH 12/12 HỘP QUÀ`;
    }
  }
...
function claimLuckyReward() {
  ...
  if (answeredQ === 9) {
    ...
    showLuckyViewFromHeader();
    document.getElementById('luckySubtitleText').innerText = `🎉 Còn ${remainingBoxes} Hộp Quà May Mắn đang chờ bạn khám phá!`;
    showToast(`Hãy chọn hộp quà tiếp theo để khám phá! 🎁 (Còn ${remainingBoxes} hộp)`);
  } else {
...
function showFinaleScreen() {
  ...
  showToast('🎉 CHÚC MỪNG NHÓM 4! BẠN ĐÃ MỞ ĐỦ 12/12 HỘP QUÀ & HOÀN THÀNH TRÒ CHƠI!');
}
...
function updateStats() {
  ...
  if (openedLucky === 12) {
    document.getElementById('openedLuckyCount').innerText = '12/12 (Đã xong)';
  } else {
  ...
  if (answeredQ === 9 && openedLucky < 12) {
    if (noticeBanner) {
      ...
      noticeBanner.innerHTML = `<i class="fa-solid fa-gift"></i> 🎉 ĐÃ HOÀN THÀNH 9/9 CÂU HỎI! (Còn ${remainingBoxes} Hộp Quà May Mắn)`;
    }
    if (headerBtn) {
      headerBtn.classList.remove('hidden');
      headerBtn.innerHTML = `<i class="fa-solid fa-gift"></i> 🎁 XEM ${remainingBoxes} HỘP QUÀ CÒN LẠI`;
    }
  } else {
