...
const questionsData = [
  ...
  },
  {
    ...
    correct: 3, // D (Per Section 14 explicit specification)
    explanation: "Đại hội III xác định: Cách mạng XHCN ở miền Bắc giữ vai trò 'quyết định nhất', còn cách mạng DTDCNN ở miền Nam giữ vai trò 'quyết định trực tiếp' đối với sự nghiệp giải phóng miền Nam."
  },
  {
    id: 7,
    ...
    correct: 3, // D
    explanation: "Quân dân ta đã áp dụng phương châm kết hợp 'hai chân' (chính trị và quân sự) và 'ba mũi giáp công' (quân sự, chính trị, binh vận) trên cả 3 vùng chiến lược (nông thôn đồng bằng, nông thôn rừng núi và đô thị)."
  },
  {
    id: 8,
